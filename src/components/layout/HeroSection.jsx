  ...
  return (
    ...
    >
      ...
      >
        <Box
          component="span"
          sx={{ color: '#FFFFFF', fontWeight: 800, fontSize: '1rem', lineHeight: 1 }}
        >
          AH
        </Box>
      </Box>
      ...
      >
        ...
        >
          <MenuItem onClick={() => setReportAnchor(null)}>Income Report</MenuItem>
          <MenuItem onClick={() => setReportAnchor(null)}>Expense Report</MenuItem>
          <MenuItem onClick={() => setReportAnchor(null)}>Balance Sheet</MenuItem>
        </Menu>
      </Box>
